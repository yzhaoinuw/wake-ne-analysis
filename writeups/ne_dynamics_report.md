...
- Among declining seconds, mean decline magnitude was **0.0680 in Low versus
  0.0583 in High Alertness**, 16.7% greater in Low.
...
- Mean variance over the preceding 10 seconds was **0.1727 in Low versus 0.1543
  in High Alertness**, 11.9% greater in Low. After removing a local linear trend,
  mean variance was **0.0605 versus 0.0704**, 14.1% lower in Low.
...
| Mean rising slope, among rising seconds | +0.07995 | +0.09588 |
| Mean decline magnitude, among declining seconds | 0.05828 | 0.06804 |

Decline magnitude is displayed as a positive value; the underlying slopes are negative.
...
with small effect magnitudes (0.025–0.061) and substantial overlap.
...
Absolute slope is the magnitude regardless of direction.

No minimum slope magnitude was imposed. Invalid signal gaps were not bridged,
...
processed NE samples in `[s-10, s)`, without additional filtering. Detrended
variance removes a fitted straight-line trend from that same window.
...
Low Alertness had greater mean slope magnitudes in both directions: 19.9% greater
among rising seconds and 16.7% greater among declining seconds.
...
declining. Right: mean slope magnitude within each direction; declining slopes
are displayed as positive magnitudes.
...
Low Alertness more often coincided with declining NE and had greater mean slope
magnitudes during both rises and declines. Mean ordinary variance was also higher
...
3.9-percentage-point frequency difference or the conditional slope magnitudes.
